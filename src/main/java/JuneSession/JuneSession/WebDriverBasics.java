...
public class WebDriverBasics {
		...
		public static void main(String[] args) {
			...
			//windows:
		      // System.setProperty("webdriver.chrome.driver", "c:\\users\\shilpipandey\\Downloads\\chromedriver.exe");
		       System.setProperty("webdriver.gecko.driver", "C:\\Users\\SHILPI.PANDEY\\geckodriver-v0.30.0-win64\\geckodriver.exe");
